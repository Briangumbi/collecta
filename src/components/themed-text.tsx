  ...
  return (
    <Text
      style={[
        ...
        type === 'hero' && { fontSize: fontSize.hero, lineHeight: fontSize.hero * 1.07, fontFamily: fonts.displayHeavy, letterSpacing: -1.5 },
        ...
        type === 'code' && { fontSize: fontSize.code, fontFamily: fonts.mono },
        // Small caption/eyebrow label — pairs with `hero`/`title` numbers.
        type === 'label' && { fontSize: fontSize.code, lineHeight: fontSize.code * 1.33, fontFamily: fonts.mono, letterSpacing: 0.6, textTransform: 'uppercase' },
        style,
      ]}
      {...rest}
    />
